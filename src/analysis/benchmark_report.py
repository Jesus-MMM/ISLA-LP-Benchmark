...
class BenchmarkReport:
    ...
    def __init__(self, runner: BenchmarkRunner, system_info: dict[str, Any] | None = None):
        self.runner = runner
    ...
    def _statistical_analysis(self, pdf: BenchmarkPDF) -> None:
        ...
        try:
            ...
            from src.analysis.statistics import anova_one_way, friedman_test, nemenyi_posthoc
